# AWS Concepts Mega Document

## Table of Contents

- [Table Of Contents](#Table of Contents)
- [01 Cloud Job Roles](#01-cloud-job-roles)
- [Cloud Architect](#Cloud Architect)
- [System Administrator (Cloud Sysadmin)](#System Administrator (Cloud SysAdmin))
- [Security Administrator](#Security Administrator)
- [Devops Engineer / Devops Administrator](#DevOps Engineer / DevOps Administrator)
- [Comparison To On Premises Roles & Top Cloud Competencies](#Comparison to On-Premises Roles & Top Cloud Competencies)
- [02 Cloud Deployment Models](#02-cloud-deployment-models)
...
- [03 Key Benefits Cloud](#03-key-benefits-cloud)
...
- [Stop Spending Money To Run And Maintain Data Centers](#Stop Spending Money to Run and Maintain Data Centers)
- [Go Global In Minutes](#Go Global in Minutes)
- [04 Global Infrastructure](#04-global-infrastructure)
- [Aws Regions](#AWS Regions)
- [Region Considerations: Compliance, Proximity, Features, Pricing](#Region Considerations: Compliance, Proximity, Features, Pricing)
- [Availability Zones (Azs)](#Availability Zones (AZs))
- [Data Centers](#Data Centers)
- [Edge Locations](#Edge Locations)
- [Levels Of Resilience: Global, Regional, Az, Edge](#Levels of Resilience: Global, Regional, AZ, Edge)
- [05 Ec2 Compute Architecture Concepts](#05-ec2-compute-architecture-concepts)
- [Ec2 Instance Types & Families](#EC2 Instance Types & Families)
- [Amazon Machine Image (Ami) Components](#Amazon Machine Image (AMI) Components)
- [Ami Sourcing](#AMI Sourcing)
- [Ec2 Pricing Concepts](#EC2 Pricing Concepts)
- [Scalability Vs Elasticity](#Scalability vs Elasticity)
- [Vm Vs Containers](#VM vs Containers)
- [06 Networking Concepts](#06-networking-concepts)
- [Amazon Vpc (Virtual Private Cloud)](#Amazon VPC (Virtual Private Cloud))
- [Public Vs Private Subnets](#Public vs Private Subnets)
- [Network Acls (Stateless Filtering)](#Network ACLs (Stateless Filtering))
- [Security Groups (Stateful Filtering)](#Security Groups (Stateful Filtering))
- [Internet Access Patterns](#Internet Access Patterns)
- [Private Access Patterns](#Private Access Patterns)
- [Public Vs Private Aws Services](#Public vs Private AWS Services)
- [Connectivity Patterns](#Connectivity Patterns)
- [07 Marketplace Reference Concepts](#07-marketplace-reference-concepts)
- [Aws Marketplace](#AWS Marketplace)
- [Aws Decision Guide For Modern Application Strategy](#AWS Decision Guide for Modern Application Strategy)
- [08 Cloud Computing Characteristics](#08-cloud-computing-characteristics)
...
- [Measured Service (Usage Monitoring & Billing)](#Measured Service (Usage Monitoring & Billing))
- [09 Availability Resilience Concepts](#09-availability-resilience-concepts)
- [High Availability (Ha)](#High Availability (HA))
- [Fault Tolerance](#Fault Tolerance)
- [Disaster Recovery (Dr)](#Disaster Recovery (DR))
- [10 Scaling Models](#10-scaling-models)
...
- [Tagging & Governance Best Practices](#Tagging & Governance Best Practices)
- [12 Cloud Adoption Migration Concepts](#12-cloud-adoption-migration-concepts)
- [Aws Cloud Adoption Framework (Caf) — Six Perspectives](#AWS Cloud Adoption Framework (CAF) — Six Perspectives)
- [1. Business Perspective](#1. Business Perspective)
- [2. People Perspective](#2. People Perspective)
- [3. Governance Perspective](#3. Governance Perspective)
- [4. Platform Perspective](#4. Platform Perspective)
- [5. Security Perspective](#5. Security Perspective)
- [6. Operations Perspective](#6. Operations Perspective)
- [1. Project Phase](#1. Project Phase)
- [2. Foundation Phase](#2. Foundation Phase)
- [3. Migration Phase](#3. Migration Phase)
- [4. Reinvention Phase](#4. Reinvention Phase)
- [1. Retire](#1. Retire)
- [2. Retain (Revisit Later)](#2. Retain (Revisit Later))
- [3. Rehost (Lift And Shift)](#3. Rehost (Lift and Shift))
- [4. Relocate](#4. Relocate)
- [5. Repurchase (“Drop And Shop”)](#5. Repurchase (“Drop and Shop”))
- [6. Replatform (“Lift, Tinker, Shift”)](#6. Replatform (“Lift, Tinker, Shift”))
- [7. Refactor / Re Architect](#7. Refactor / Re-Architect)
- [Cloud Center Of Excellence (Ccoe)](#Cloud Center of Excellence (CCoE))
- [Sustainability & Modernization Goals](#Sustainability & Modernization Goals)
- [13 Cloud Economics](#13-cloud-economics)
- [Total Cost Of Ownership (Tco)](#Total Cost of Ownership (TCO))
- [Opex Vs Capex](#OpEx vs CapEx)
- [Labor & Licensing Costs](#Labor & Licensing Costs)
- [Rightsizing & Elastic Cost Reduction](#Rightsizing & Elastic Cost Reduction)
- [Cost Visibility & Accountability](#Cost Visibility & Accountability)
- [14 Shared Responsibility Model](#14-shared-responsibility-model)
- [Overview](#Overview)
- [Unmanaged Services (E.G., Ec2)](#Unmanaged Services (e.g., EC2))
- [Managed Services (E.G., Rds, Amazon Mq)](#Managed Services (e.g., RDS, Amazon MQ))
- [Fully Managed Services (E.G., Dynamodb, S3, Sns)](#Fully Managed Services (e.g., DynamoDB, S3, SNS))
- [Customer Side Responsibilities](#Customer-Side Responsibilities)
- [Aws Responsibilities](#AWS Responsibilities)
- [Customer Responsibilities](#Customer Responsibilities)
- [Aws Responsibilities](#AWS Responsibilities)
- [Customer Responsibilities](#Customer Responsibilities)
- [Aws Responsibilities](#AWS Responsibilities)
- [15 Security Compliance Concepts](#15-security-compliance-concepts)
- [Cloud Security (General)](#Cloud Security (General))
- [Governance & Compliance](#Governance & Compliance)
- [Encrypt Data At Rest](#Encrypt Data at Rest)
- [Encrypt Data In Transit](#Encrypt Data in Transit)
- [Monitoring & Audit Readiness](#Monitoring & Audit Readiness)
- [16 Iam Account Concepts](#16-iam-account-concepts)
- [Aws Account Model](#AWS Account Model)
- [Root User Capabilities](#Root User Capabilities)
- [Iam Users](#IAM Users)
- [Iam Groups](#IAM Groups)
- [Iam Roles](#IAM Roles)
- [Iam Policies](#IAM Policies)
- [Managed Vs Customer Managed Policies](#Managed vs Customer-Managed Policies)
- [Identity Federation](#Identity Federation)
- [Iam Policy Evaluation Logic](#IAM Policy Evaluation Logic)
- [Putting It Together — Common Exam Patterns](#Putting It Together — Common Exam Patterns)
- [17 Cloud Architecture Concepts](#17-cloud-architecture-concepts)
- [Api Access, Aws Cli, And Management Console](#API Access, AWS CLI, and Management Console)
- [Infrastructure As Code (Iac)](#Infrastructure as Code (IaC))
- [Deployment Models: Cloud Native, Hybrid, On Premises](#Deployment Models: Cloud-Native, Hybrid, On-Premises)
- [Levels Of Service Resilience (Global → Regional → Az → Edge)](#Levels of Service Resilience (Global → Regional → AZ → Edge))
- [Resource Level Resilience](#Resource-Level Resilience)
- [Tagging And Governance Best Practices](#Tagging and Governance Best Practices)
- [Metrics Monitoring & Observability](#Metrics Monitoring & Observability)
- [Cost Visibility & Enforcement (Architecture Level)](#Cost Visibility & Enforcement (Architecture Level))
- [18 Cloud Models Service Models](#18-cloud-models-service-models)
- [Overview](#Overview)
- [19 Database Architecture Concepts](#19-database-architecture-concepts)
- [Relational Vs Non Relational Databases](#Relational vs Non-Relational Databases)
- [Primary & Standby Instances (Synchronous Replication)](#Primary & Standby Instances (Synchronous Replication))
- [Read Replicas (Asynchronous Replication)](#Read Replicas (Asynchronous Replication))
- [In Memory Caching](#In-Memory Caching)
- [Global Databases](#Global Databases)
- [Serverless Database Scaling (Acus In Aurora Serverless)](#Serverless Database Scaling (ACUs in Aurora Serverless))
- [20 Storage Concepts](#20-storage-concepts)
- [Object Storage](#Object Storage)
- [File Storage](#File Storage)
- [Block Storage](#Block Storage)
- [Storage Gateway Modes](#Storage Gateway Modes)
- [Backup & Disaster Recovery Patterns (Storage Level)](#Backup & Disaster Recovery Patterns (Storage-Level))
- [21 Ai Ml Concepts](#21-ai-ml-concepts)
- [Ml Frameworks (Tensorflow, Pytorch, Apache Mxnet)](#ML Frameworks (TensorFlow, PyTorch, Apache MXNet))
- [Capacity Units (Example: Acus In Aurora Serverless & Ml Compute Units)](#Capacity Units (Example: ACUs in Aurora Serverless & ML Compute Units))
- [Ai Capabilities (Extraction, Classification, Computer Vision)](#AI Capabilities (Extraction, Classification, Computer Vision))
- [Ml Hosting, Training & Inference Concepts](#ML Hosting, Training & Inference Concepts)
- [Generative Ai Concepts (High Level)](#Generative AI Concepts (High-Level))
- [22 Other Architectural Concepts](#22-other-architectural-concepts)
- [Public Zone Vs Private Zone](#Public Zone vs Private Zone)
- [Resource Level Resilience](#Resource-Level Resilience)
- [Tagging Strategies](#Tagging Strategies)
- [Account Structure & Governance](#Account Structure & Governance)
- [Metrics Monitoring & Observability](#Metrics Monitoring & Observability)
- [Cost Visibility & Enforcement](#Cost Visibility & Enforcement)
- [23 Pricing And Billing Concepts](#23-pricing-and-billing-concepts)
- [Reserved Instances (Ris)](#Reserved Instances (RIs))
- [On Demand Instances](#On-Demand Instances)
- [Spot Instances](#Spot Instances)
- [Dedicated Instances & Dedicated Hosts](#Dedicated Instances & Dedicated Hosts)
- [Capacity Reservations](#Capacity Reservations)
- [Savings Plans](#Savings Plans)
- [Rightsizing](#Rightsizing)
- [Elasticity For Cost Optimization](#Elasticity for Cost Optimization)
- [Choosing The Correct Pricing Model](#Choosing the Correct Pricing Model)
- [Cost Management Strategies](#Cost Management Strategies)
- [Cost And Usage Visibility](#Cost and Usage Visibility)
- [24 Support Concepts](#24-support-concepts)
...
- [4. Enterprise On Ramp Support](#4. Enterprise On-Ramp Support)
...
- [25 Cloud Job Roles](#25-cloud-job-roles)
- [Overview](#Overview)
- [26 Cloud Deployment Models](#26-cloud-deployment-models)
- [Overview](#Overview)
- [27 Key Benefits Of Cloud Computing](#27-key-benefits-of-cloud-computing)
- [Overview](#Overview)
- [28 Global Infrastructure Concepts](#28-global-infrastructure-concepts)
- [Overview](#Overview)
- [29 Networking Core Concepts](#29-networking-core-concepts)
- [Overview](#Overview)
- [Client Vpn](#Client VPN)
- [Site To Site Vpn](#Site-to-Site VPN)
- [Direct Connect](#Direct Connect)
- [Hybrid Connectivity](#Hybrid Connectivity)
- [30 Marketplace Reference Concepts](#30-marketplace-reference-concepts)
- [Overview](#Overview)
- [31 Cloud Computing Characteristics Nist](#31-cloud-computing-characteristics-nist)
- [Overview](#Overview)
